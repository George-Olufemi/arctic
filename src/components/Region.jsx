    ...
    <div>
      <div className="md:flex">
        <Zoom>
          <div>
            <img
              className='woman h-[1024px]  object-cover bg-gradient-to-r from-cyan-500 to-blue-500"'
        ...
        <Zoom>
          <div>
            <img
              className="snow h-[1024px]  object-cover"
        ...
        <Zoom>
          <div>
            <img
              className="ski h-[1024px]  object-cover"
